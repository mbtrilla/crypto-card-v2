        ...
        cardsToRender.forEach((card, index) => {
            ...
            cardEl.innerHTML = `
                <div class="card-image-wrapper">
                    <img src="${logo}" alt="${name} image" class="card-full-image" referrerpolicy="no-referrer" onerror="this.src='${fallbackImage}'">
                </div>
                
                <div class="card-content-bottom">
                    <div class="card-meta-tags">
                        <span class="blue-pill">${custody.toUpperCase()}</span>
                        ${networkRaw ? `<span class="blue-pill">${networkRaw.toUpperCase()}</span>` : ''}
                    </div>
