...
export async function GET(req: NextRequest) {
  ...
  const title = searchParams.get('title') || 'Sweepbase';
    ...
    (
      ...
      >
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          {subtitle && (
            <p style={{ color: '#8b9abf', fontSize: '22px', margin: '0 0 14px 0', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
              {subtitle}
            </p>
          )}
        ...
        >
          <span style={{ color: '#5b7cff', fontSize: '18px', fontWeight: 600 }}>sweepbase.com</span>
          <span style={{ color: '#8b9abf', fontSize: '18px' }}>Independent Crypto Card Comparison</span>
        </div>
      </div>
    ),
